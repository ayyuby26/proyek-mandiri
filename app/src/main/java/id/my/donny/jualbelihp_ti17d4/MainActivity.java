...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private void showUpdateForm() {
        ...
        System.out.println("Coba1 " +in.putExtra("nama", selectedList.getNama()));
    ...
    private void processResponse(String response) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                handphone.setNama(obj.getString("phone_name")); //sebelumnya "nama"
                handphone.setHarga(obj.getString("price")); //sebelumnya "harga"
    ...
    private void populateListView() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View v, int pos, long id)
            {
                ...
                in.putExtra("id", selectedList.getId().toString());
                in.putExtra("nama", selectedList.getNama());
                System.out.println("Coba2 " +in.putExtra("nama", selectedList.getNama()));
                in.putExtra("harga", selectedList.getHarga());
                startActivity(in);
        }
    });
